...
The personal-use deployment stays private because it contains real job-search data. This repo now supports a separate public demo deployment with its own database, seeded demo records, and a daily reset.
